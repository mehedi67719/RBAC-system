...
const Page = () => {
  ...
  const handleCreateTask = async (formData) => {
    ...
    setMessage(res.ok ? "Task created successfully" : res.message);
  };
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="priority" className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="assignee" className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="category" className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div>
                ...
                <select name="relatedTo" className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              <label className="flex items-center space-x-2">
                <input type="checkbox" name="setReminder" className="w-4 h-4 text-blue-600 rounded" />
                <span className="text-sm text-gray-700">Set reminder</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" name="emailNotification" className="w-4 h-4 text-blue-600 rounded" />
                <span className="text-sm text-gray-700">Send email notification</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="checkbox" name="isRecurring" className="w-4 h-4 text-blue-600 rounded" />
